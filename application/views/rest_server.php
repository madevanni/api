...
<div id="container">
    ...
    <div id="body">
        ...
        <ol>
            <li><a href="<?php echo site_url('api/example/partners'); ?>">Partners</a> - defaulting to JSON</li>
            ...
            <li><a href="<?php echo site_url('api/example/partners/id/PIJF001'); ?>">Partner #PIJF001</a> - defaulting to JSON  (users/id/1)</li>
